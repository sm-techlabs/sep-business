...
import ReviewFMNonRegisteredEventRequestForm from "../forms/ReviewFMNonRegisteredEventRequestForm";
import ReviewFMRegisteredEventRequestForm from "../forms/ReviewFMRegisteredEventRequestForm";

const EventRequestTableFM = ({ filter = {}, mode }) => {
  ...
  const handleEdit = async (id) => {
    try {
      ...
      if (response.type === "registered") {
        openModalWithContent(<ReviewFMRegisteredEventRequestForm id={id} />);
      } else {
        openModalWithContent(<ReviewFMNonRegisteredEventRequestForm id={id} />);
      }
    } catch (err) {
...
export default EventRequestTableFM;
